...
-Plot the limits on sigma/sigma_{SM}* BR(h->aa) as a function of the mass of the pseudoscalar for each type of 2HDM+1S model as a function of ![formula](https://render.githubusercontent.com/render/math?math=tan\beta) 
