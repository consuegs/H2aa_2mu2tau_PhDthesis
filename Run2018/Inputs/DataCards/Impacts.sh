...
combineTool.py -m $2 -M Impacts --allPars --doInitialFit --robustFit 1  --rMin -10 --rMax 10 --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND --X-rtd FITTER_NEW_CROSSING_ALGO -d workspace_${1}.root
combineTool.py -m $2 -M Impacts --robustFit 1 --doFits  --rMin -10 --rMax 10 --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND --X-rtd FITTER_NEW_CROSSING_ALGO -d workspace_${1}.root
