...
void PlotBDTDiscriminant(TString mass = "5p0", TString massD = "5", TString trk = "_lep_lep", bool blinddata = false, bool drawLeg = true, bool logY = true)
{
	...
	TFile *file = new TFile("../DataCards/haa-13TeV_2018_ma" + mass + trk + ".root");
...
void PlotDiscriminant(TString mass = "5p0", TString massD = "5.0", bool blinddata = false, bool drawLeg = true, bool logY = true)
{
