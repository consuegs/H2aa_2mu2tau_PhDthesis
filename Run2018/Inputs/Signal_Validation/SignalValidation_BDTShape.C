	...
	)
{
	...
	reader->BookMVA("BDT", "/nfs/dust/cms/user/consuegs/H2aa_2mu2tau/Run2018/MVA_BDT/ma" + mass_string + "/weights/TMVAClassification_BDT" + trackCat + ".weights.xml");
	...
	c->SaveAs("SignalValidation" + trackCat + "_Ma" + mass_string + ".png");
	delete c;
