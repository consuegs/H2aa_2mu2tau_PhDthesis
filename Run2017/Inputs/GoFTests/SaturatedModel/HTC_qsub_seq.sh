...
do
  ...
  cp ../../../DataCards/haa-13TeV_2017_ma${mass}_lep_lep.txt ./
  cp ../../../DataCards/haa-13TeV_2017_ma${mass}_lep_had.txt ./
  cp ../../../DataCards/haa-13TeV_2017_ma${mass}_had_had.txt ./
  ...
  do
   ...
   combine -M GoodnessOfFit haa-13TeV_2017_ma${mass}_had_had.txt --algo=saturated --fixedSignalStrength=0.0 --toysFreq -m $massf -t 200 -s ${j}
