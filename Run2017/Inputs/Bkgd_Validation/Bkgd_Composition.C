...
void Get_Composition(TString HistName = "histWeights_00NN_lep_lepH", TString region = "_00NN", TString category = "_lep_lep")
{
	...
	///////////////////////////////// Directory String	////////////////////////////////////////////                    
	TString dir = "/nfs/dust/cms/user/consuegs/H2aa_2mu2tau/Run2017/";

	TFile *file_data = new TFile(dir + "CreateHistos/SingleMuon_Run2017_CompStudy_output.root");
	...
	double ngen[25] = { 7791498,	// WW    (0)
		3928630,	// WZ                    (1)
		1949768,	// ZZ                    (2)
		74635450,	// WJets                 (3)	        
		1,	// ST_t-channel_antitop          (4)
		1,	// ST_t-channel_top              (5)
		1,	// ST_tW_antitop                 (6)
		1,	// ST_tW_top                     (7)		
		//1,	// TTbar                     (8)
		1,	// TTTo2L2Nu                     (8)
		1,	// TTToSemiLeptonic              (9)
		1,	// TTToHadronic                  (10)
		39521230,	// DYJetsToLL_M-10to50   (11)
		97800939,	// DYJetsToLL_M-50       (12)			
        28213684,	                 // QCD  (13)
        29887635,	                 // QCD  (14)
        24188535,	                 // QCD  (15)
        23265607,	                 // QCD  (16)
	...
	for (int isample = 0; isample < nMCSamples; isample++)
	{
		...
		if (isample > 12 && isample < 24)
		{
			norm = xsec[isample] *lumi / ngen[isample];
		}
